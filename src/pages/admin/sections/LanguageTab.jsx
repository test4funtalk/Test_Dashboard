      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-4 sm:gap-4">
        <div className="rounded-xl bg-neutral-900 p-3 text-white sm:rounded-2xl sm:p-4">
          <div className="flex items-start justify-between">
            <p className="text-2xl font-black sm:text-3xl">{languages.length}</p>
            <Languages size={17} className="opacity-50" />
          </div>
          <p className="mt-0.5 text-xs font-medium opacity-70 sm:mt-1">Total Languages</p>
        </div>
        <div className="rounded-xl border border-neutral-200 bg-neutral-50 p-3 sm:rounded-2xl sm:p-4">
          <div className="flex items-start justify-between">
            <p className="text-2xl font-black sm:text-3xl">{filtered.length}</p>
